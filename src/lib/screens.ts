...
export const WORLDS: WorldMeta[] = [
  ...
  { id: "m1",      title: "Taso 1", subtitle: "Omat ydinvahvuudet",                               emoji: "🌟", start: 11, end: 27, tone: "coral"  },
  { id: "m2",      title: "Taso 2", subtitle: "Omat vahvuudet lukiossa",                          emoji: "🎓", start: 28, end: 40, tone: "mint"   },
  { id: "m3",      title: "Taso 3", subtitle: "Omat vahvuudet kotona",                            emoji: "🏠", start: 41, end: 46, tone: "teal"   },
  { id: "m4",      title: "Taso 4", subtitle: "Omat vahvuudet vapaa-ajalla ja harrastuksissa",    emoji: "🎨", start: 47, end: 54, tone: "purple" },
  { id: "m5",      title: "Taso 5", subtitle: "Omat vahvuudet ystävyyssuhteissa",                 emoji: "🤝", start: 55, end: 58, tone: "coral"  },
  { id: "m6",      title: "Taso 6", subtitle: "Vahvuusportfolion kokoaminen",                     emoji: "🏆", start: 59, end: 76, tone: "yellow" },

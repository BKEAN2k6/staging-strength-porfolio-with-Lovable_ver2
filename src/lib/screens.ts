...
export const WORLDS: WorldMeta[] = [
  ...
  { id: "m2",      title: "Taso 2", subtitle: "Omat vahvuudet lukiossa", start: 30, end: 42, tone: "mint"   },
  { id: "m3",      title: "Taso 3", subtitle: "Omat vahvuudet kotona", start: 43, end: 48, tone: "teal"   },
  { id: "m4",      title: "Taso 4", subtitle: "Omat vahvuudet vapaa-ajalla ja harrastuksissa", start: 49, end: 56, tone: "purple" },
  { id: "m5",      title: "Taso 5", subtitle: "Omat vahvuudet ystävyyssuhteissa", start: 57, end: 60, tone: "coral"  },
  { id: "m6",      title: "Taso 6", subtitle: "Vahvuusportfolion kokoaminen", start: 61, end: 76, tone: "yellow" },

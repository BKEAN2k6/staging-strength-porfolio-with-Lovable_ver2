...
export const REQUIREMENTS: Record<number, string[]> = {
  ...
  13: [
    "screen_13_hyva_tanaan", "screen_13_kolme_hyvaa", "screen_13_vahvuudet_opinnoissa",
    "screen_13_osaan", "screen_13_autoin", "screen_13_hyvaa_toisissa",
  ...
  36: Array.from({ length: 10 }, (_, i) => `screen_33_erityistaito_${i + 1}`),

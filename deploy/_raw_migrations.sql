...
CREATE TRIGGER responses_touch_updated_at
  ...
  FOR EACH ROW EXECUTE FUNCTION public.touch_updated_at();
UPDATE public.user_roles SET role = 'teacher' WHERE user_id = 'befd871c-10bb-4798-b5ed-67a08f3bfa80';ALTER PUBLICATION supabase_realtime ADD TABLE public.responses;
